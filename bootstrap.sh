...
echo "          BENCH NEW-SITE    "
echo "--------------------------------------"
printf $MARIA_DB_PASS"\n"$WEB_ADMIN_PASS"\n"$WEB_ADMIN_PASS | bench new-site develop.local
bench --site develop.local install-app process_success
bench use develop.local

echo "--------------------------------------"
echo "     BENCH MIGRATE AND socketio    "
echo "--------------------------------------"
bench migrate
